...
export const GET = async (req: Request) => {
  try {
    ...
    const payload: ActionGetResponse = {
      title: "Solana Fluff 预购中! 🔥🔥🔥",
      icon: new URL("/Fluff.png", requestUrl.origin).toString(),
      description: "在 Solana 区块链的虚拟世界中，存在着一种神秘的生物——Fluffies。他们是毛茸茸的小精灵，以其可爱的外表和善良的性格而闻名。Fluffies 喜欢在区块链的每一个角落探险，发现隐藏的宝藏和秘密。",
